...
namespace JSONParser
{
    ...
    public class NumberHandler : Tokenizable
    {
        ...
        static bool isJSONNumber(Input input)
        {
            ...
            || isDot(currentCharacter, nextCharacter)
            || isNegative(currentCharacter, nextCharacter)
            || isExponent(currentCharacter, nextCharacter)
            || isExponentSign(currentCharacter, nextCharacter);
        }
